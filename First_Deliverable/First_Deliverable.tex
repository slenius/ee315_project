...
\section{Sample Rate}
  ...
  \begin{equation}
    % not sure what the call is for unit "sample", but capital S called by
    % \siemens, so should be find for current report.
...
\section{Final Transient Simulations}
  ...
  %%%%% Noiseless transient simulation figure
  \begin{figure}[h]
    \begin{center}
  ...
  %%%%% Noiseless transient simulation FFT figure
  \begin{figure}[h]
    \begin{center}
  ...
  %%%%% Noisy transient simulation figure
  \begin{figure}[h]
    \begin{center}
  ...
  %%%%% Noisy transient simulation FFT figure
  \begin{figure}[h]
    \begin{center}
